...
namespace GameCore {
	...
	using SceneAddComponentFunc = void(*)(Entity& entity, json& jsonData, GameCore::Scene& scene);
	class Scene
	{
	...
	public:
		...
		map<int, Render::Mesh*> meshs;
		map<int, Render::Texture*> textures;
		map<int, Render::Material*> materials;
		//场景资源路径索引
